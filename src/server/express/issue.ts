...
issueRouter.get('/', (req, res, next) => {
  ...
  jira.makeRequest({url: `https://legalcoins.atlassian.net/rest/api/2/search?jql=project="${PROJECT_KEY}" AND status="Backlog"&fields=id,key,status,assignee`}, (error, body) => {
